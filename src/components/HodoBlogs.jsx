  ...
  const blogs = [
    {
      ...
      description:
        "Hodo Stays: Your ideal Short and Long-Term Rental in HSR Layout, Bangalore",
      image: "/blog-1.jpg",
    },
    {
      id: 2,
      ...
      description:
        "Discover the best attractions Bangalore has to offer from your stay at Hodo Stays in HSR Layout.",
      image: "/blog-2.jpg",
    },
    {
      id: 3,
    ...
    },
    {
      ...
      description:
        "Explore the vibrant cafe culture around Hodo Stays and discover your next favorite spot.",
      image: "/blog-1.jpg",
    },
    {
      id: 5,
      ...
      description:
        "Perfect destinations for a quick escape while staying at Hodo Stays in Bangalore.",
      image: "/blog-2.jpg",
    },
  ];
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="flex flex-col md:grid md:grid-cols-12 gap-8 md:items-start">
          ...
          <div className="md:col-span-4 lg:col-span-5 text-left">
            ...
            >
              Dive into our world! Explore travel tips, local insights, and the
              latest updates from Hodo Stays.
            </p>
          ...
          <div className="md:col-span-8 lg:col-span-7 relative">
            ...
            <button
              onClick={scrollLeft}
              className="hidden md:flex absolute -left-6 top-1/2 -translate-y-1/2 w-16 h-16 bg-white/60 rounded-full items-center justify-center hover:bg-white/80 transition-all duration-300 z-20 shadow-lg hover:shadow-xl hover:scale-105"
              style={{
            ...
            >
              <svg
                className="w-8 h-8 text-gray-600/80"
                fill="none"
                stroke="currentColor"
                viewBox="0 0 24 24"
              >
            ...
            <button
              onClick={scrollRight}
              className="hidden md:flex absolute -right-6 top-1/2 -translate-y-1/2 w-16 h-16 bg-white/60 rounded-full items-center justify-center hover:bg-white/80 transition-all duration-300 z-20 shadow-lg hover:shadow-xl hover:scale-105"
              style={{
                border: "1px solid rgba(0,0,0,0.05)",
                backdropFilter: "blur(8px)",
              }}
              ...
              {blogs.map((_, i) => (
                <button
                  ...
                  className={`w-3 h-3 rounded-full transition-all ${
                    i === activeIndex ? "scale-110" : "opacity-60"
                  }`}
                  style={{
                    backgroundColor:
                      i === activeIndex ? "#ffffff" : "rgba(255,255,255,0.5)",
                    boxShadow:
                      i === activeIndex ? "0 2px 6px rgba(0,0,0,0.3)" : "none",
                  }}
                />
              ))}
            </div>
