          ...
          <div className="max-w-4xl">
            ...
            <div className={`p-6 rounded-xl border transition-colors duration-300 mb-8 ${isDarkMode ? 'bg-[#1a1a1a] border-[#333333]' : 'bg-white border-gray-200'}`}>
              <div className="flex items-start gap-6 max-md:flex-col max-md:gap-4">
                {/* Left: Overall Rating */}
                <div className="text-center flex-shrink-0 max-md:text-left max-md:w-full">
                  <div className="flex items-center gap-3 max-md:justify-start md:flex-col md:items-center">
                    ...
                    <div className="flex flex-col items-start md:items-center">
                      ...
                      <div className={`text-xs mt-1 transition-colors duration-300 ${isDarkMode ? 'text-gray-400' : 'text-gray-600'}`} style={{ fontFamily: 'Work Sans' }}>
                ...
                <div className="flex-1 space-y-1.5 max-md:w-full">
                  {[
