  ...
  return (
    <section className="py-20 px-8 min-h-screen flex items-center max-md:py-12 max-md:px-4" style={{ backgroundColor: '#FFF7F0' }}>
      <div className="max-w-7xl mx-auto w-full">
        ...
        <div className="flex items-center justify-center gap-66 max-lg:flex-col max-lg:gap-12">
          {/* Card Stack */}
          <div className="relative flex-shrink-0" style={{ width: '400px', height: '500px' }}>
              ...
              return (
                <div
                  ...
                  style={{
                    ...
                    transform: `rotate(${card.angle - (stackIndex * 3)}deg) translateX(${stackIndex * 15}px) translateY(${stackIndex * 8}px)`,
          ...
          <div className="flex-shrink-0">
            ...
            >
              ...
              <button 
                onClick={nextCard}
                className="absolute right-4 top-1/2 transform -translate-y-1/2 w-12 h-12 bg-gray-100 rounded-full flex items-center justify-center hover:bg-gray-200 transition-colors z-10"
              >
                <svg className="w-6 h-6 text-gray-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              ...
              <div className="text-center px-16 h-full flex flex-col justify-center">
                <h3 className="text-3xl font-bold text-gray-900 mb-6 max-md:text-2xl">
